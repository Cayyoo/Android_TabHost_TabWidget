...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//TabHost mTabHost=getTabHost();//继承自TabActivity的方法
		...
		mTabHost.addTab(mTabHost.newTabSpec("tab1").setIndicator("标签1", getResources().getDrawable(R.drawable.ic_launcher)).setContent(R.id.tab1));
        ...
        mTabHost.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            @Override
